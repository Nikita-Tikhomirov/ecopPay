...
<html lang="ru">
  <head>
      ...
      <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=b6af280b-3054-41c9-9212-d1aded1e7f7e" type="text/javascript"></script>
    ...
    <div class="header-wrap header-wrap-content">
        ...
        <div class="header" id="myHeader">
            ...
            <div class="header-top">
                ...
                <a href="/" class="logo">
                    <img src="<?php echo get_template_directory_uri(); ?>/images/Logo2.png" alt="Логотип учебного центра">
                </a>
                ...
                <div class="header__buttons-wrap">
                    <a data-fancybox data-src="#hidden-content" href="javascript:;" class="header-message header-message__top">Заказать
                        звонок</a>
                    <a href="https://ecoprf.upft.ru/" target="_blank" class="header-message" style="margin-top:10px;text-align:center;">Личный кабинет</a>
 ...
 <div class="hederSearch">
        ...
        <h1 data-aos="fade-up" data-aos-duration="600" class="content-h1">
            <span>
                <?php the_title(); ?>
            </span>
        </h1>
